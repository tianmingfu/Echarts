...
_Component({
    ...
    methods: {
        init: function(callback) {
            console.log("canvascanvascanvas22")
            ...
            query
                ...
                .exec((res)=>{
                  console.log("canvascanvascanvas33",res);
                  ...
                  if (typeof callback === "function") {
                    console.log('canvascanvascanvas111');
                    ...
                    console.log('canvascanvascanvas112');
                      this.chart = this.data.ec.onInit(canvas, w, h);
                  } else {
                    console.log('canvascanvascanvas113');
